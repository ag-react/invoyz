...
function InvoiceListItem(props: ComponentProps) {
  ...
  return (
    <div className="rounded-lg w-full grid grid-cols-list-banner auto-rows-auto bg-white dark:bg-indigo-darker cursor-pointer transition duration-150 ease-in-out border border-transparent hover:border-indigo gap-x-6 gap-y-6 p-6 px-6 md:py-4 md:grid-cols-list-big"
      ...
      <div className="col-start-2 col-end-3 md:col-start-3 flex items-center justify-end md:col-end-4 md:justify-start text-right">
